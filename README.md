...
<section id="team">
    ...
    <div class="team-grid">
        <div class="member"><div class="avatar">💻</div><h3>CHAVEZ, REN'Z BRIAN D.</h3><p>ENCODER</p></div>
        <div class="member"><div class="avatar">💻</div><h3>LIMBA, SHAHER BEN ABDULLAH K.</h3><p>ENCODER</p></div>
        <div class="member"><div class="avatar">📖</div><h3>TIRADO, NOELLE KRISTEN B.</h3><p>INTRODUCTION</p></div>
        <div class="member"><div class="avatar">⚠️</div><h3>QUIJOTE, EUGEM KINTH Q.</h3><p>COMMON THREATS</p></div>
        <div class="member"><div class="avatar">⚠️</div><h3>GIRASOL, MATT MENRYK M.</h3><p>COMMON THREATS</p></div>
        <div class="member"><div class="avatar">📚</div><h3>PACQUIAO, JOHN MIER A.</h3><p>RESOURCES</p></div>
        <div class="member"><div class="avatar">📚</div><h3>MESIAS, HART KADEN P.</h3><p>RESOURCES</p></div>
        <div class="member"><div class="avatar">📚</div><h3>ABADIANO, JOHN KEVIN S.</h3><p>RESOURCES</p></div>
    </div>
</section>

<footer>
    <strong>🛡️ CYBERGUARD</strong>
    <p>Cybersecurity & Online Safety • Grade 12 STEM 3</p>
    <p>Stay alert. Stay responsible. Stay safe online.</p>
</footer>
